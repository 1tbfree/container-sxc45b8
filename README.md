...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sxc45b8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sxc45b8.containers.anotherwebservice.com/
...
```
git clone git@github.com:1tbfree/container-sxc45b8.git
cd container-sxc45b8
```
...
```
docker attach container-sxc45b8
```
